 ...
 * @author Ka Wing Chin
 */
public class Lesson4 extends FlxState
{
	private final String VERTEX = "examples/gles20/lesson4/vertex_shader.glsl";
	private final String FRAGMENT = "examples/gles20/lesson4/fragment_shader.glsl";
	...
	public void create()
	{
		...
		ShaderProgram shader = FlxG.loadShader("multitexturing", VERTEX, FRAGMENT);
