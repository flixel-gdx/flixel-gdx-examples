...
public class RagDoll extends FlxGroup
{
	public RagDoll(float x, float y)
	{
		...
		// Head
		B2FlxCircle head = new B2FlxCircle(x + 2f, y - 1f, 12.5f)
		...
		B2FlxBox torso1 = new B2FlxBox(x, y + 28f, 30f, 20f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// 2nd Torso
		B2FlxBox torso2 = new B2FlxBox(x, y + 43f, 30f, 20f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// 3rd Torso
		B2FlxBox torso3 = new B2FlxBox(x, y + 58f, 30f, 20f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// Upper Arm L
		B2FlxBox upperArmL = new B2FlxBox(x-33f, y+24f, 36f, 13f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// Upper Arm R
		B2FlxBox upperArmR = new B2FlxBox(x+27f, y+24f, 36f, 13f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// Lower Arm L
		B2FlxBox lowerArmL = new B2FlxBox(x-60f, y+24f, 34f, 12f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// Lower Arm R
		B2FlxBox lowerArmR = new B2FlxBox(x+57f, y+24f, 34f, 12f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// Upper Leg L
		B2FlxBox upperLegL = new B2FlxBox(x, y+73f, 15f, 44f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// Upper Leg R
		B2FlxBox upperLegR = new B2FlxBox(x+15f, y+73f, 15f, 44f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// Lower Leg L
		B2FlxBox lowerLegL = new B2FlxBox(x+1f, y+110f, 12f, 40f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
		...
		// Lower Leg R
		B2FlxBox lowerLegR = new B2FlxBox(x+17f, y+110f, 12f, 40f)
			.setFixtureDef(fixDef)
			.setResetAngle(false)
			.setDraggable(true)
			.create();
